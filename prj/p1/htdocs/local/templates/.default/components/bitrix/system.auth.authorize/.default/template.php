...
<div class="bx-auth">
	...
	<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
		...
		<table class="bx-auth-table" style="width: auto; margin-bottom: 20px;">
			<tr>
				<td><input class="bx-auth-input" type="text" name="USER_LOGIN" placeholder="<?=GetMessage("AUTH_LOGIN")?>" maxlength="255" value="<?=$arResult["LAST_LOGIN"]?>" /></td>
			</tr>
			<tr>
				<td><input class="bx-auth-input" type="password" name="USER_PASSWORD" placeholder="<?=GetMessage("AUTH_PASSWORD")?>" maxlength="255" autocomplete="off" />
...
<?endif?>
			...
			<?if($arResult["CAPTCHA_CODE"]):?>
				...
				<tr>
					<td><input class="bx-auth-input" type="text" name="captcha_word" placeholder="<?echo GetMessage("AUTH_CAPTCHA_PROMT")?>" maxlength="50" value="" size="15" /></td>
				</tr>
			<?endif;?>
