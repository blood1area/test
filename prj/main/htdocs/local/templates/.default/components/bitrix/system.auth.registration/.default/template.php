...
<table class="data-table bx-registration-table">
	...
	<tbody>
		...
		<tr>
			<td><span class="starrequired">*</span><?=$arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></td>
		...
		<tr>
			...
			<td><input type="text" name="USER_EMAIL" maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" class="bx-auth-input" placeholder="name@site.domain" /></td>
		</tr>
<?// ********************* User properties ***************************************************?>
